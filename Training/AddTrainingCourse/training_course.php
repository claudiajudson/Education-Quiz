...
<h1 id='home_header'> ADD TRAINING COURSE </h1>


<div class='form_area'>
    <div class="form_container">
        <h3>Training Course Form</h3>
        ...
        <form class = "training_course_form" action="./training_course_auth.php" method="post"  id="training_course_form" autocomplete="off">

            <?php if(isset($smsg)){ ?><div class="alert alert-success" role="alert"> <?php echo $smsg; ?> </div><?php } ?>
            <input type="text" placeholder="Name of course" name="course_name" required/> <!-- Required makes sure every input box is filled -->
