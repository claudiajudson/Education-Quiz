...
$result = mysqli_query($conn, "SELECT * FROM Test_Paper ORDER BY Id ASC");
...
<h1 id='home_header'> MANAGE TESTS </h1>
...
<div class="TABLE">
    <table width='80%' border=0 align="center">
        ...
        while($res = mysqli_fetch_array($result)) {
            ...
            echo "<td>".$res['Max_Score']."</td>";
            echo "<td><a href=\"tests_edit.php?id=$res[Id]\">Edit</a>";
        }
        ?>
    </table>
</div>
